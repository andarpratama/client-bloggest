        ...
        <div className="min-h-96 bg-teal-50 dark:bg-teal-800">
            <div className="container mx-auto flex items-center justify-between">
                <div className="min-h-96 flex flex-col justify-center">
                    ...
                    <h2 className="text-teal-900 text-6xl font-semibold mb-4 dark:text-gray-100">
                        <span>I&apos;m</span> <span className="font-extrabold underline cursor-pointer">Andar</span>
                    </h2>
                    <p className="text-teal-900 dark:text-gray-200">As a Fullstack Engineer with more than <span className="font-bold">5 Years Experience</span></p>
                </div>
                <div>
                    <Image
